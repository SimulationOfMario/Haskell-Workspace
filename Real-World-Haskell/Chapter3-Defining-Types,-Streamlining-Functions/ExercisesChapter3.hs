...
testSet1 = [(0,-5.4), (3.2,-4), (6,-1), (5,2), (2,4), (0,5.2),
            ...
            (3,-3), (3,0)] 
-- * Use this to compare the solution of testSet1
solutionSet1 :: [CartesianPoint2D]
solutionSet1 = [(0.0,-5.4),(3.2,-4.0),(6.0,-1.0),(5.0,2.0),(2.0,4.0),(0.0,5.2),(-3.0,4.0),(-5.0,1.0),(-5.0,-4.0),(0.0,-5.4)]
